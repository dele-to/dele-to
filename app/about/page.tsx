      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Zero-Knowledge Security Architecture</h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <Card>
              <CardHeader>
                <Lock className="w-8 h-8 mb-2" style={{ color: '#D2461E' }} />
            ...
            <Card>
              <CardHeader>
                <Key className="w-8 h-8 mb-2" style={{ color: '#D2461E' }} />
            ...
            <Card>
              <CardHeader>
                <Server className="w-8 h-8 mb-2" style={{ color: '#D2461E' }} />
            ...
            <Card>
              <CardHeader>
                <Eye className="w-8 h-8 mb-2" style={{ color: '#D2461E' }} />
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">Web Crypto API generates cryptographically secure key</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 text-white rounded-full flex items-center justify-center text-sm font-bold" style={{ backgroundColor: '#D2461E' }}>
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">AES-256-GCM encryption with unique IV</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 text-white rounded-full flex items-center justify-center text-sm font-bold" style={{ backgroundColor: '#D2461E' }}>
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">Only ciphertext and IV stored, never the key</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 text-white rounded-full flex items-center justify-center text-sm font-bold" style={{ backgroundColor: '#D2461E' }}>
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">Fragment (#) never sent to server</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 text-white rounded-full flex items-center justify-center text-sm font-bold" style={{ backgroundColor: '#D2461E' }}>
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">Recipient's browser decrypts using key from URL</p>
                    </div>
                  </div>
                </div>
              </div>
